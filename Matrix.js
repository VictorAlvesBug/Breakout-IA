class Matrix {
    ...
    static add(A, B) {
        if (A.rows != B.rows || A.cols != B.cols) {
            throw new Error('Matrizes não compatíveis para efetuar adição.');
            return null;
        }
    ...
    static subtract(A, B) {
        if (A.rows != B.rows || A.cols != B.cols) {
            throw new Error('Matrizes não compatíveis para efetuar subtração.');
            return null;
        }
    ...
    static multiply(A, B) {
        if (A.cols != B.rows) {
            throw new Error('Matrizes não compatíveis para efetuar multiplicação.');
            return null;
        }
    ...
    static hadamard(A, B) {
        if (A.rows != B.rows || A.cols != B.cols) {
            throw new Error('Matrizes não compatíveis para efetuar produto Hadamard.');
            return null;
        }
